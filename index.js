...
const drawPreview = (context, textColors) => {
...
const pixelsToTextColors = (pixels) => {
    const textColors = [];
...
const textColorsToAnsiString = (textColors) => {
    let string = "> ```ansi\n> ";
    textColors.forEach((color, i) => {
...
const getDifference = (color1, color2) => {
...
const getPixels = (url, callback) => {
    ...
    image.onload = () => {
        ...
        context === null || context === void 0 ? void 0 : context.drawImage(image, 0, 0, 8, 8);
        const pixels = context === null || context === void 0 ? void 0 : context.getImageData(0, 0, canvas.width, canvas.height).data;
        if (pixels == undefined) {
